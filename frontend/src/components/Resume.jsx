     ...
     <div className='intro'>
        <div className='resume-text'>
            ...
            <p>
                ...
                in <a href="https://en.wikipedia.org/wiki/LaTeX" title="Learn more about LaTeX"><strong>LaTeX</strong></a> using 
                <a href="https://www.overleaf.com" title="Visit Overleaf"><strong>Overleaf</strong></a> which
